...
Media skills: image, audio, and video processing workflows.
...
Skills are loaded automatically when Claude detects media-related context. Mention image generation, image enhancement, or video downloading to trigger the appropriate skill.
